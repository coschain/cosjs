...
class Wallet {
  ...
  chainInfo() {
    ...
    return _asyncToGenerator(function* () {
      const nonParamsRequest = new _cosGrpcJs.grpc.NonParamsRequest();
      return new Promise(resolve => _this5.cos.grpc.unary(ApiService.GetChainState, {
        request: nonParamsRequest,
  ...
  blockProducerList(start, limit, lastBlockProducer, raw) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return new Promise(resolve => _this6.cos.grpc.unary(ApiService.GetBlockProducerListByVoteCount, {
  ...
  createAccount(creator, newAccount, pubkey) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const signTx = yield _this7.signOps(creator, [acop]);
  ...
  transfer(sender, receiver, amount, memo) {
    ...
    return _asyncToGenerator(function* () {
      ...
      top.setMemo(memo);
      const signTx = yield _this8.signOps(sender, [top]);
  ...
  accountUpdate(owner, newPubKey) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const signTx = yield _this9.signOps(owner, [aop]);
  ...
  cosToVest(account, amount) {
    ...
    return _asyncToGenerator(function* () {
      ...
      sendAmount.setValue(value.toString());
      top.setAmount(sendAmount);
      const signTx = yield _this10.signOps(account, [top]);
  ...
  vestToCos(account, amount) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const signTx = yield _this11.signOps(account, [cop]);
  ...
  cosToStake(account, amount, toAccount) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const signTx = yield _this12.signOps(account, [sop]);
  ...
  post(sender, title, content, tagsStr) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const signTx = yield _this14.signOps(sender, [pop]);
  ...
  contractCall(caller, owner, contract, method, args, payment) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const signTx = yield _this15.signOps(caller, [callOp]);
  ...
  voteToBlockProducer(voterValue, bpValue, cancel) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const signTx = yield _this16.signOps(voterValue, [bpVoteOp]);
  ...
  queryTable(owner, contract, table, field, begin, limit, reverse) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return new Promise(resolve => _this17.cos.grpc.unary(ApiService.QueryTableContent, {
        request: getTableContentRequest,
        host: _this17.cos.provider,
        onEnd: res => {
          const {
            status,
            statusMessage,
          ...
          if (status === _this17.cos.grpc.Code.OK && message) {
            let object = message.toObject();
            resolve(object);
          } else {
            resolve({
